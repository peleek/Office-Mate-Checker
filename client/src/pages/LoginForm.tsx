...
export const LoginForm = ({ setInputChange, errors, loading, handleFormChange, onLoginSubmit }) => {
	const classes = useStyles();
	return (
		<form noValidate autoComplete="off" className={classes.paper} onSubmit={onLoginSubmit}>
